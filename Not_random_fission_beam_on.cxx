...
int main() {
 ...
 pixel = 681;
  ...
  if(fission_model == "one_or_average"){
    ...
    while (input){
      input>>temp_value;
      if(fission_array[temp_value] == 50) cout<<"Hmmmmmmmmmm"<< temp_value<<endl;
      fission_array[temp_value] = fission_array[temp_value] + 50;
    }
    //FULFIX!!!!!! P.G.A. att sista värdet tas med två gånger 
    fission_array[621] = 50;    
    for(int i = 0; i < 1024; i++){
      if(fission_array[i] == 0){
	fission_array[i] = 50*63.0/1024.0;    
      } 
    }
